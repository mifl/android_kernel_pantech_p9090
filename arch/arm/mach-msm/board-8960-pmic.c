...
/* mirinae added 20111214 Start */
	...
	defined (CONFIG_MACH_MSM8960_VEGAPVW) || defined (CONFIG_MACH_MSM8960_SIRIUSLTE) || defined (CONFIG_MACH_MSM8960_EF44S) || defined (CONFIG_MACH_MSM8960_MAGNUS)
...
#ifndef CONFIG_MACH_MSM8960_SIRIUSLTE	//p11309
	[1] = {
...
#if defined(CONFIG_MACH_MSM8960_CHEETAH) || defined(CONFIG_MACH_MSM8960_STARQ)  // mirinae_LED
	[2] = {
