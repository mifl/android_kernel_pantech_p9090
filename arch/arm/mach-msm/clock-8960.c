...
/*20120614 yjw to get rid of warning at boot time*/
#if defined(CONFIG_MACH_MSM8960_EF44S) || defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_MAGNUS)	
	clk_set_rate(&gsbi3_qup_clk.c, 24000000);
        clk_set_rate(&gsbi4_qup_clk.c, 24000000);
        clk_set_rate(&gsbi10_qup_clk.c, 24000000);
#endif
#if defined(CONFIG_MACH_MSM8960_EF44S)
        clk_set_rate(&gsbi8_qup_clk.c, 24000000); 
#endif  
#if defined(CONFIG_MACH_MSM8960_VEGAPVW)
        clk_set_rate(&gsbi1_qup_clk.c, 24000000); 
        clk_set_rate(&gsbi2_qup_clk.c, 24000000); 
#endif  
