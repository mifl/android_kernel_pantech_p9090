...
// 20120623 lcj@LS3 logging for wifi mac
//#define USE_LOGGING_WIFI_MAC
...
printk (KERN_INFO "init_wifi_mem\n") ;
...
#if defined(CONFIG_TOUCHSCREEN_QT602240_MSM8960) || defined(CONFIG_TOUCHSCREEN_CYTTSP_I2C) || defined(CONFIG_TOUCHSCREEN_CYTTSP_GEN4) ||defined(CONFIG_TOUCHSCREEN_MAX11871)
	.clk_freq = 384000,	
#else
	.clk_freq = 100000,
#endif
...
static struct resource ram_console_resource[] = {
	{
		...
		.end  = ANDROID_RAM_CONSOLE_START + ANDROID_RAM_CONSOLE_SIZE ,
		.flags = IORESOURCE_MEM,
	}
};
...
#if (defined(CONFIG_MACH_MSM8960_SIRIUSLTE) && (BOARD_VER>=WS10)) /* 2012.04.26 changed by akira... install UART_Console */
...
#endif /* CONFIG_ISL9519_CHARGER */
#ifdef CONFIG_TOUCHSCREEN_CYTTSP_I2C	// p11309
	{
...
static void __init register_i2c_devices(void)
{
	...
	if (machine_is_msm8960_svlte() || machine_is_msm8960_cheetah() ||
		...
		machine_is_msm8960_siriuslte()||  machine_is_msm8960_ef44s() ||  machine_is_msm8960_magnus()) {
		mach_mask = I2C_SURF;
	}	
#else  //QCT org
