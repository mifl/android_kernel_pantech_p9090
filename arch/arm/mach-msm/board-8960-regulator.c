...
#if !defined(CONFIG_MACH_MSM8960_CHEETAH) && !defined(CONFIG_MACH_MSM8960_OSCAR) && !defined(CONFIG_MACH_MSM8960_VEGAPVW) && !defined(CONFIG_MACH_MSM8960_SIRIUSLTE) 
	REGULATOR_SUPPLY("dsi_vddio",		"mipi_dsi.1"),
#endif
...
msm_rpm_regulator_init_data[] __devinitdata = {
	...
	RPM_LDO(L8,  0, 1, 0, 2800000, 2800000, NULL,	   0, 0),
#endif
#elif defined(CONFIG_PANTECH_CAMERA) && defined(CONFIG_MACH_MSM8960_EF44S)
	RPM_LDO(L8,	 0, 1, 0, 2800000, 2800000, NULL,      0, 0),
#else
