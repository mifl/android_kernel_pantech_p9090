...
// p10998@LS3 for debugging, watchdog reset due to the spin lock overwrite.
// this code should be removed in the end.
#if defined(T_EF44S)
//#define LOGGING_ROOTDOMAIN_ALLOC
#endif
...
#ifdef LOGGING_ROOTDOMAIN_ALLOC
	pr_info("free_rootdomain: rd 0x%x\n", (u32)rd); 
#endif
...
#ifdef LOGGING_ROOTDOMAIN_ALLOC
	pr_info("alloc_rootdomain: rd 0x%x\n", (u32)rd); 
#endif
	return rd;
}
