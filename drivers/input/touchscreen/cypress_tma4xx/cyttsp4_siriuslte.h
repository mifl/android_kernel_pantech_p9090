...
#define CY_NUM_RETRY                10 /* This is a device feature. It should not be revised. p11309-wcjeong */
 ...
 */
/* recommend EDGE Trigger - on interrupt Async Mode - p11309 */
 ...
 * when HW power reset, Bootloader Process Time is about 400~500msec.
 * Sleep Current is under 10uA On sleep mode.
 * recommend CY_USE_SOFT_SUSPEND_RESUME_MODE.
 */
...
#define CY_USE_PMIC_POWER	0
#if CY_USE_PMIC_POWER
	#define TOUCH_POWER_VDD		"8921_l17"//2.8 ~ 3.3V
	#define TOUCH_POWER_I2C		"8921_l21"// 1.8
#else
