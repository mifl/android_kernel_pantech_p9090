...
#endif
#if defined(CONFIG_MACH_MSM8960_MAGNUS) || defined (CONFIG_MACH_MSM8960_SIRIUSLTE) || defined (CONFIG_MACH_MSM8960_EF44S)
int charger_flag;
...
static int msm_fb_probe(struct platform_device *pdev)
{
	...
	defined (CONFIG_MACH_MSM8960_EF46L) || defined (CONFIG_MACH_MSM8960_STARQ) ||\
	defined (CONFIG_MACH_MSM8960_OSCAR) || defined (CONFIG_MACH_MSM8960_EF44S) ||\
...
#elif defined(CONFIG_MACH_MSM8960_MAGNUS) || defined(CONFIG_MACH_MSM8960_VEGAPVW) ||defined(CONFIG_MACH_MSM8960_EF44S)
      struct fb_info *fbi = mfd->fbi;
...
//	printk("[%s:PROGRESS] bkl_lvl = %d , mfd->bl_level = %d\n",__func__,bkl_lvl, mfd->bl_level);
...
#endif
{
	...
	defined(CONFIG_MACH_MSM8960_VEGAPVW) || defined(CONFIG_MACH_MSM8960_SIRIUSLTE) ||\
