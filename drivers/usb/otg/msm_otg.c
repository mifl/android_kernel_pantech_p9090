...
static void msm_otg_start_host(struct otg_transceiver *otg, int on)
{
	...
	if (on) {
		...
		ulpi_write(otg, 0x33, 0x81);
		ulpi_write(otg, 0x13, 0x83);
		}else{
...
#endif
        INIT_DELAYED_WORK(&motg->pmic_id_status_work, msm_pmic_id_status_w);  //153615 patch
