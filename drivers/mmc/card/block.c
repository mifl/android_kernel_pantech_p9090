...
#if 0
	printk("############################################\n");
	printk("card_status=[%08x]\n", card_data_to_user.card_status);
	printk("ccs=[%d]\n", card_data_to_user.ccs);
	printk("pa cap=[%d]\n", card_data_to_user.capacity_of_protected_area_in_byte);
	printk("user cap=[%d]\n", card_data_to_user.capacity);
	printk("secure_mode=[%d]\n", card_data_to_user.ssr.secure_mode);
	printk("############################################\n");	
#endif
