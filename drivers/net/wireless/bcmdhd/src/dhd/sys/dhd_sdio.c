...
#if defined(DHD_DEBUG) && defined(USE_DHD_DUMP_CIS)
static void
...
#endif /* DHD_DEBUG  && USE_DHD_DUMP_CIS*/
...
#ifdef FEATURE_PANTECH_WLAN_SEMCO
static void
...
*/
			// 0x22 : Sharp FEM
			// 0x33 : Triquint FEM
			if ( data[4] == 0x57 && (data[5] == 0x22 || data[5]==0x33) ) {
				strcpy( nv_path, "/system/etc/nvram_4334_ss.txt");
...
#endif //FEATURE_PANTECH_WLAN_SEMCO
static bool
...
#if defined(DHD_DEBUG) || defined(FEATURE_PANTECH_WLAN_SEMCO)
#if defined(FEATURE_PANTECH_WLAN_SEMCO)
	if (1) 
#else
	if (DHD_INFO_ON()) 
#endif
...
#endif /* defined(DHD_DEBUG) || defined(FEATURE_PANTECH_WLAN_SEMCO) */
