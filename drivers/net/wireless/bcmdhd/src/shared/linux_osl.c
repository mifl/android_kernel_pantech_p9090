...
// 20120622 lcj@LS3 logging or not when allocating large buffer for huge packet.
//#define USE_LOGGING_WHEN_HUGE_PACKET
...
#if defined(CUSTOMER_HW4) || defined(CUSTOMER_HW11)
...
#ifdef USE_LOGGING_WHEN_HUGE_PACKET 
