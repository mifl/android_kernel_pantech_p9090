...
*/
	{0x12, 0x04},           
	{0x20, 0x00},           
	{0x21, 0x04}, //0c}, //08_23_H_binning           
	{0x22, 0x00},           
	{0x23, 0x07}, //14}, //08_23_H_binning           
	{0x03, 0x18},           
	{0x10, 0x00},           
	//{0x03, 0x22},           
        //{0x80, 0x40}, //38}, //R gain
...
#ifndef F_STREAM_ON_OFF	
 	{0x03, 0x00},                     
	{0x01, 0x31}, // 0xf1}, 08_23_parallel pad off      
#endif
	{0x03, 0x20}, //AE OFF 
	{0x10, 0x0C},         
	{0x03, 0x22}, //AWF OFF
...
#ifndef F_STREAM_ON_OFF	
	{0x03, 0x00},		
   	{0x01, 0x30},// 0xf0},//{0x01, 0xf8}, 08_23_parallel pad off    
#endif	
#endif
};
...
{0x10, 0x95}, //15}, //11}, //Sub 1 + Preview 1 mode //08_23_H_binning 
#if (BOARD_VER<TP10 && defined(CONFIG_MACH_MSM8960_EF44S)) || defined(CONFIG_MACH_MSM8960_MAGNUS) || (BOARD_VER == WS10 && defined(CONFIG_MACH_MSM8960_SIRIUSLTE))
	{0x11, 0x93},
#else
...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_cfg_preview_fps[][YACD5C1SBDBC_PREVIEW_FPS_PARM] = {//[25][57]
    {//Fixed 5 fps
        ...
        {0x03, 0x00},
        {0x10, 0x95}, //15}, //Sub 1 + Preview 1 mode //08_23_H_binning 
#if (BOARD_VER<TP10 && defined(CONFIG_MACH_MSM8960_EF44S)) || defined(CONFIG_MACH_MSM8960_MAGNUS) || (BOARD_VER == WS10 && defined(CONFIG_MACH_MSM8960_SIRIUSLTE))
