...
static struct msm_camera_i2c_reg_conf yacd5c1sbdbc_cfg_effect[][YACD5C1SBDBC_EFFECT_PARM] = {//[14][8]
	...
	{0x12, 0x30},
	{0x13, 0x00},
//	{0x40, 0x80}, // brightnedd reg delete
	{0x44, 0x80},
	{0x45, 0x80},
	{0x46, 0xF0},
...
#if (BOARD_VER<TP10 && defined(CONFIG_MACH_MSM8960_EF44S)) || defined(CONFIG_MACH_MSM8960_MAGNUS) || (BOARD_VER == WS10 && defined(CONFIG_MACH_MSM8960_SIRIUSLTE))
    	{0x11, 0x87}, //B[2] Fixed Frame XY flip (90:Default) 
#else
...
{0x92, 0x86}, 
{0x93, 0x78}, 
{0x9c, 0x06}, //EXP Limit 1700.68 fps 
{0x9d, 0xe4}, 
{0x9e, 0x01}, //EXP Unit 
{0x9f, 0x26}, 
{0x03, 0x20}, //Page 20 
