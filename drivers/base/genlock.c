...
#if 1 // PANTECH - CRs-fixed: 359649 (0002) / Case: 00859191 [p12484 2012.06.20.] 
...
struct genlock {
#if 1 // PANTECH - Case: 00859191 [p12484 2012.06.20.] 
...
#if 1 // PANTECH - CRs-fixed: 359649 (0001) / Case: 00859191 [p12484 2012.06.20.] 
...
static int genlock_handle_release(struct inode *inodep, struct file *file)
{
	...
	kfree(handle);
	file->private_data=NULL; //CR359649
